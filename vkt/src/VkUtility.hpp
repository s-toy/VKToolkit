...
namespace hiveVKT
{
	...
	static uint32_t findMemoryTypeIndex(uint32_t vMemoryTypeFilter, vk::MemoryPropertyFlags vMemoryPropertyFilter)
	{
	...
	static void executeImmediately(vk::Device vDevice, vk::CommandPool vCommandPool, vk::Queue vQueue, const std::function<void(vk::CommandBuffer vCommandBuffer)>& vFunction)
	{
	...
	static void createBuffer(vk::Device vDevice, vk::DeviceSize vBufferSize, vk::BufferUsageFlags vBufferUsage, vk::MemoryPropertyFlags vMemoryProperty, vk::Buffer& voBuffer, vk::DeviceMemory& voBufferDeviceMemory)
	{
